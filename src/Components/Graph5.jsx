    ...
    exporting: {
      buttons: {
        contextButton: {
          ...
          ] // Remove other menu items and keep only full screen
        },
      },
    },
  };
          ...
          <div className="dropdown">
            ...
            {dropdownVisible && (
              <div className="dropdown-content show">
                <button onClick={() => exportChart('image/png')}>Download PNG image</button>
                <button onClick={() => exportChart('image/jpeg')}>Download JPEG image</button>
                <button onClick={() => exportChart('application/pdf')}>Download PDF document</button>
                <button onClick={() => exportChart('image/svg+xml')}>Download SVG vector image</button>
              </div>
            )}
          </div>
        </div>
