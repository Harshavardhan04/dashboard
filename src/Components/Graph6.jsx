...
const HighchartsGraph = () => {
  ...
  }, [startDate, endDate, selectedCurrencies, compareWithTarget, showSpikeLines, loading, data, isDarkMode]);
        ...
        <div className="chart-controls">
          ...
          <div className="dropdown">
            ...
            <div className="dropdown-content">
              <button onClick={() => Highcharts.exportCharts([Highcharts.charts[0]], { type: 'image/png' })}>Download PNG image</button>
              <button onClick={() => Highcharts.exportCharts([Highcharts.charts[0]], { type: 'image/jpeg' })}>Download JPEG image</button>
              <button onClick={() => Highcharts.exportCharts([Highcharts.charts[0]], { type: 'application/pdf' })}>Download PDF document</button>
              <button onClick={() => Highcharts.exportCharts([Highcharts.charts[0]], { type: 'image/svg+xml' })}>Download SVG vector image</button>
            </div>
          </div>
